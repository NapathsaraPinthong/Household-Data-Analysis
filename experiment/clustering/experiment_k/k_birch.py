...
for k in k_values:
    ...
    # Apply BIRCH clustering with n_clusters=k
    birch = Birch(n_clusters=k, threshold=2.0)  # Adjust threshold if necessary
    labels = birch.fit_predict(node_embeddings_scaled)
...
plt.title('Silhouette Analysis for BIRCH Clustering')
