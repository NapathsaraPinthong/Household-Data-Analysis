...
perform_kmeans_clustering(
    ...
    k=k,
    output_excel_path='./result/kmeans_clusters_k3.xlsx',  # Adjust file name based on k
    output_json_path='../../pages/clustering_plot/kmeans_plot_k3.json'  # Adjust file name based on k
)