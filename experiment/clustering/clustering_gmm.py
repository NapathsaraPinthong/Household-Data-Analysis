...
perform_gmm_clustering(
    ...
    k=k,
    output_excel_path='./result/gmm_clusters_k3.xlsx',  # Adjust file name based on components
    output_json_path='../../pages/clustering_plot/gmm_plot_k3.json'  # Adjust file name based on components
)