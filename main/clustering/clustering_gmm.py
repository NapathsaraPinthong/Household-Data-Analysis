...
cluster_df.to_excel('./gmm_clusters.xlsx',index=False)
print("Household's cluster label by GMM saved to './gmm_clusters.xlsx'")
...
with open('../../pages/clustering_plot/gmm_plot.json', 'w') as f:
    json.dump(plot_data, f)

print("GMM plot data saved to '../../pages/clustering_plot/gmm_plot.json'")